...
/* BOOLEAN:INT (../.././glib-2.42.1/tests/gobject/testmarshal.list:2) */
...
/* STRING:INT (../.././glib-2.42.1/tests/gobject/testmarshal.list:3) */
...
/* VARIANT:POINTER (../.././glib-2.42.1/tests/gobject/testmarshal.list:4) */
